...
import wildmill.timetable.adapters.BlogRecyclerAdapter;
import wildmill.timetable.models.Blog;
...
public class BlogTransitionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Some of colors
        final int[] color = {0xFFC2185B, 0xFFB3E5FC, 0xFFFFEB3B, 0xFFF8BBD0, 0xFFFF5252,
                0xFFE91E63, 0xFF448AFF,};
        // Some of images
        int[] drawable = {R.drawable.q, R.drawable.w, R.drawable.e,
                R.drawable.r, R.drawable.t, R.drawable.y, R.drawable.u};
        ...
        for (int i = 0; i < color.length; i++) {
            ...
            blog.setTitle(week[i]);
            if (week[i].equals("Среда")) {
                blog.setSubTitle("Расписание пар:\n8:30 - 14:15");
            }else{
                blog.setSubTitle("Расписание пар:\n8:30 - 13:50");
            }
            if(week[i].equals("Суббота")){
                blog.setSubTitle("Расписание пар:\n8:30 - 12:00");
            }
            if(week[i].equals("Воскресенье")){
                blog.setSubTitle("Выходной");
            }
            mBlogList.add(blog);
        }
                ...
                .addOnItemTouchListener(new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View itemView, int position) {
                                if (position == 0){
                                    Table.setText(R.string.Monday);
                                }
                                if(position == 1){
                                    Table.setText(R.string.Tuesday);
                                }
                                if(position == 2){
                                Table.setText(R.string.Wednesday);
                                }
                                if(position == 3){
                                    Table.setText(R.string.Thursday);
                                }
                                if(position == 4){
                                    Table.setText(R.string.Friday);
                                }
                                if(position == 5){
                                    Table.setText(R.string.Saturday);
                                }
                                if(position == 6){
                                    Table.setText(R.string.Sunday);
                                }
                                if (!isOpen) {
